...
public class Kinder {
	...
	public Kinder(String kinderName, String kinderAge) {
		this.kinderName = kinderName;
		this.kinderAge = kinderAge;
	}
	
	public Kinder(String kinderId, String kinderName, String kinderAge, String kinderClass, String parentPhone,
	...
	public String toString() {
		return "[원생번호 : " + kinderId + ", 원생이름 : " + kinderName + ", 원생나이 : " + kinderAge + ", 반 : " + kinderClass
				+ ", 입학일 : " + admissionDate + ", 부모님연락처 : " + parentPhone + "]";
	}
